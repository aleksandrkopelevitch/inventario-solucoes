...
/**
 * Flattens a GitBook space's page tree into the flat, `position`-ordered list
 * `documentation_pages` actually stores.
 *
 ...
 * child pages), while a DocumentationGroup here has ONE level. Depth-first
