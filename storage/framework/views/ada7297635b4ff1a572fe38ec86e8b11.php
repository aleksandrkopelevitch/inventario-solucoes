...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.button','data' => ['type' => 'button','variant' => 'ghost','dataAkFiltersClear' => ''.e(json_encode(['formId' => 'companies-filter-form', 'field' => $chip['field'], 'url' => route('companies.index')])).'','ariaLabel' => 'Remover filtro '.e($chip['value']).'','class' => '!rounded-full !p-0 !text-xs size-4 shrink-0 bg-accent/15 !text-accent hover:!bg-accent hover:!text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'ghost','data-ak-filters-clear' => ''.e(json_encode(['formId' => 'companies-filter-form', 'field' => $chip['field'], 'url' => route('companies.index')])).'','aria-label' => 'Remover filtro '.e($chip['value']).'','class' => '!rounded-full !p-0 !text-xs size-4 shrink-0 bg-accent/15 !text-accent hover:!bg-accent hover:!text-white']); ?>
                &times;
...
<?php endif; ?>
    ...
    <?php if(count($chips)): ?>
        <?php if (isset($component)) { $__componentOriginal48c3958713aa2b1d2dd1900fbfcfc804 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal48c3958713aa2b1d2dd1900fbfcfc804 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.button','data' => ['type' => 'button','variant' => 'ghost','dataAkFiltersClearAll' => ''.e(json_encode(['formId' => 'companies-filter-form', 'url' => route('companies.index')])).'','class' => '!rounded-none !p-0 !text-xs underline decoration-line-2 underline-offset-2 hover:!bg-transparent']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('forms.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'ghost','data-ak-filters-clear-all' => ''.e(json_encode(['formId' => 'companies-filter-form', 'url' => route('companies.index')])).'','class' => '!rounded-none !p-0 !text-xs underline decoration-line-2 underline-offset-2 hover:!bg-transparent']); ?>
            Limpar tudo
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal48c3958713aa2b1d2dd1900fbfcfc804)): ?>
...
<?php /**PATH /home/alexandre/inventario-solucoes/resources/views/components/companies/filter-chips.blade.php ENDPATH**/ ?>