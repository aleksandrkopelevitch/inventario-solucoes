...
function orthogonalPoints(p0, p3, stub = EDGE_STUB, offset = 0) {
    ...
    // ends: with two blocks close together, an 18px detour put the corridor
    // behind the originating block and the arrow went out, back over itself and
    // in again. Clamped to the gap, the dense case loses a little separation
